...
./LoReHLT_Frame_Scorer.py \
    -g ./datasets/IL9/situation_frame/ \
    -s $OURFILE \
    -o $SCORE_DIR \
    -m $SYSNAME \
    -l ./datasets/IL9/IL9_all_filelist.txt \
    -p IL9_CP2_all_ 
...
./LoReHLT_Frame_Scorer.py \
    ...
    -o $SCORE_DIR \
    -m $SYSNAME \
    -l ./datasets/IL9/IL9_filelist.txt \
    -p IL9_CP2_IL_text_
...
./LoReHLT_Frame_Scorer.py \
    ...
    -o $SCORE_DIR \
    -m $SYSNAME \
    -l ./datasets/IL9/ENG_IL9_filelist.txt \
    -p IL9_CP2_ENG_text_ 
...
./LoReHLT_Frame_Scorer.py \
    ...
    -o $SCORE_DIR \
    -m $SYSNAME \
    -l ./datasets/IL9/IL9+ENG_filelist.txt \
    -p IL9_CP2_IL+ENG_text_ 
...
./LoReHLT_Frame_Scorer.py \
    ...
    -o $SCORE_DIR \
    -m $SYSNAME \
    -l ./datasets/IL9/IL9_speech_filelist.txt \
    -p IL9_CP2_speech_ 
